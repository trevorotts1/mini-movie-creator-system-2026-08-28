...
## Batch 13 — Merged (2026-08-29T08:30Z, integration ddd5748..c365e8e, pushed)
- REC-010 (ecf4722) — re-cert QC sha 8fd8217 verified ancestor of rebased tip 2c85766; one state/task-updates/REC-010.qc.json add/add conflict resolved to the branch round
- REC-011 (550a6da) — clean; REL-003 (c365e8e) — clean
- Regression PASS: pnpm -r test RC=0 (apps/cli 152/152, integrations/claude 45/45, integrations/openclaw 23/23); typecheck 17/17 RC=0; full vitest 4010 passed/1 skipped (backup.test.ts 5s-timeout flake on first run — batch-11/12-proven, one disclosed retry, clean rerun); examples acceptance 7/7; tsc -p examples clean; sim suites 28/28; pnpm-lock unchanged
- Baseline carried: providers '@mmcs/core/idempotency' bare-subpath load failure repros only under packages/providers local include pattern — identical on integration base, no active owner; suites 68/68 from root
- Unblocked: REL-004 -> READY (all 9 deps MERGED; control fold only — orchestrator dispatches build); REL-005/006 remain BLOCKED
